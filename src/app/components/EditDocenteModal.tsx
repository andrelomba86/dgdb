...
// import { deletaTelefoneDocente } from '../api/docentes/services/DocenteService'

// interface EditDocenteModalProps {
//   isOpen: boolean
//   onClose: () => void
//   onUpdate: () => void
//   docente?: DadosDocente
// }

// const EditDocenteModal: React.FC<EditDocenteModalProps> = ({ isOpen, onClose, onUpdate, docente }) => {
...
//           if (telefone.id) {
//             return fetch('/api/docentes/telefones', {
//               method: 'PUT',
//               headers: { 'Content-Type': 'application/json' },
...
//                         try {
//                           if (telefone.id) {
//                             await deletaTelefoneDocente(telefone.id)
//                           }
...
//                   onClick={() => {
//                     const newTelefones = [...(formData.telefones || [])]
//                     newTelefones.push({ id: 0, telefone: '', tipo: '', docente_id: formData.id })
//                     setFormData({ ...formData, telefones: newTelefones })
//                   }}>
//                   Adicionar Telefone
//                 </Button>
